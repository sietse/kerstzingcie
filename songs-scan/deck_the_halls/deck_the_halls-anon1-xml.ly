...
PartPOneVoiceTwo =  {
    \clef "treble" \key f \major \time 4/4 | % 1
    \tempo 2=116 s1*6 | % 7
    d'8 [ d'8 d'8 d'8 ] f'8 ( [ e'8 ) d'8 ( f'8 ) ] s1*3 | % 11
    a'4 g'4 a'4 f'4 s1*3 | % 15
    d'8 [ d'8 d'8 d'8 ] f'8 ( [ e'8 ) d'8 ( f'8 ) ] s1 \bar "|."
    }
...
PartPTwoVoiceTwo =  {
    ...
    bes8 [ a8 g8 bes8 ] d'8 ( [ c'8 ) ] bes4 s1*3 | % 11
    d4 e4 f4 d4 s1*3 | % 15
    bes,8 [ a,8 g,8 bes,8 ] d8 ( [ c8 ) ] bes,4 s1 \bar "|."
    }
